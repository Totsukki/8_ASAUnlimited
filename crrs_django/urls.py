...
urlpatterns = [
    ...
    path('admin_dashboard', views.MyAdminDashboardView.as_view(), name="my_admindashboard_view"),
    path('users', views.MyUsersView.as_view(), name="my_users_view"),
    path('rooms', views.MyRoomsView.as_view(), name="my_rooms_view"), 
    path('reservations', views.MyReservationsView.as_view(), name="my_reservations_view"),
